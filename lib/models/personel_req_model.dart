...
PersonelReqModel personelReqModelFromJson(String str) =>
    PersonelReqModel.fromJson(json.decode(str));

String personelReqModelToJson(PersonelReqModel data) => json.encode(data.toJson());

class PersonelReqModel {
  int? id;
  String? name;
  String? surname;
  String? citizenNo;
  ...
  factory PersonelReqModel.fromJson(Map<String, dynamic> json) => PersonelReqModel(
        id: json["id"],
        name: json["name"],
